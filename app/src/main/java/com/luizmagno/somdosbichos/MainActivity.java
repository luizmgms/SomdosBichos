        ...
        try {
            ...
            switch (v.getId()){
                case R.id.caoId:
                    ...
                    Toast.makeText(this, R.string.cao_str, Toast.LENGTH_SHORT).show();
                    break;
                case R.id.gatoId:
                    afd = getResources().openRawResourceFd(R.raw.gato);
                    Toast.makeText(this, R.string.gato_str, Toast.LENGTH_SHORT).show();
                    break;
                case R.id.leaoId:
                    afd = getResources().openRawResourceFd(R.raw.leao);
                    Toast.makeText(this, R.string.leao_str, Toast.LENGTH_SHORT).show();
                    break;
                case R.id.macacoId:
                    afd = getResources().openRawResourceFd(R.raw.macaco);
                    Toast.makeText(this, R.string.macaco_str, Toast.LENGTH_SHORT).show();
                    break;
                case R.id.ovelhaId:
                    afd = getResources().openRawResourceFd(R.raw.ovelha);
                    Toast.makeText(this, R.string.ovelha_str, Toast.LENGTH_SHORT).show();
                    break;
                case R.id.vacaId:
